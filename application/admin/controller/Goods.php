...
class Goods extends Backend
{
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $list = $this->model
                ->where(['goods.is_del' => 0,'goods.is_manghe'=>0,'goods.is_manghe_goods'=>0])
                ->with(['goodsrank'])
                ->where($where)
                ->order($sort, $order)
                ->paginate($limit);
    ...
    public function part(){
        ...
        return json(['list'=>$part]);
    }

    public function list()
    {
        return json($this->model->where(['is_del' => 0,'is_manghe'=>0,'is_manghe_goods'=>0])->select());
    }
